import{a as l,j as e,H as o}from"./app-CW8xlGRN.js";import{r as n}from"./vendor-i18n-CRXc3HNV.js";/* empty css            */import"./vendor-recharts-DYP2vlyo.js";const d={draft:"Draft",active:"Active",expired:"Expired",cancelled:"Cancelled"};function t(a){return a?new Date(a).toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"}):"—"}function x(){const{contract:a,org:i}=l().props;n.useEffect(()=>{const r=setTimeout(()=>window.print(),700);return()=>clearTimeout(r)},[]);const s=d[a.status]??a.status;return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:`${a.contract_number}`}),e.jsx("style",{children:`
